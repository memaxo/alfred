...
const fallbackDir = () => FileSystem.cacheDirectory ?? FileSystem.documentDirectory ?? "";
...
export async function playBase64(audioBase64: string, mimeType: string): Promise<void> {
