...
describe("PrivacyControls", () => {
  ...
  it("respects disabled props", () => {
    render(<PrivacyControls forgetDisabled exportDisabled />);
    
    const exportButton = screen.getByRole("button", { name: /Export Data/i }) as HTMLButtonElement;
    const deleteButton = screen.getByRole("button", { name: /Delete All Data/i }) as HTMLButtonElement;
