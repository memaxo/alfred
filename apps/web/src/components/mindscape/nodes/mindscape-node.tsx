...
export function MindscapeNode({
  ...
  return (
    <Node
      handles={handles}
      className={cn(
        "min-w-[300px] border border-white/10 bg-void-surface/40 backdrop-blur-xl transition-all duration-200",
        selected && "border-biolum shadow-[0_0_15px_rgba(var(--biolum-rgb),0.3)]",
        className
      )}
    >
      ...
      <Toolbar position="top" className="opacity-0 group-hover:opacity-100 transition-opacity -translate-y-12">
        <Button size="icon" variant="ghost" className="h-6 w-6 hover:text-biolum">
