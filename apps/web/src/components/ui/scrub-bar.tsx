...
function ScrubBarThumb({ className, children, ...props }: ScrubBarThumbProps) {
  ...
  return (
    <div
      className={cn(
        "-translate-x-1/2 -translate-y-1/2 absolute top-1/2 block h-4 w-4 rounded-full bg-primary transition-colors disabled:pointer-events-none disabled:opacity-50",
        className
      )}
