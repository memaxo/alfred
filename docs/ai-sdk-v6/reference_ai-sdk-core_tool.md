...
async (input: INPUT, options: ToolCallOptions) => RESULT | Promise | AsyncIterable
...
(options: ToolCallOptions) => void | PromiseLike
...
(options: { inputTextDelta: string } & ToolCallOptions) => void | PromiseLike
...
(options: { input: INPUT } & ToolCallOptions) => void | PromiseLike
...
The ID of the tool for provider-defined tools. Should follow the format `.`. Required when type is "provider-defined".
