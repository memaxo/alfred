...
[Next.js-style](https://bun.com/docs/api/file-system-router#next-js-style) [Reference](https://bun.com/docs/api/file-system-router#reference)
...
[Previous\\
\\
SQLite](https://bun.com/docs/api/sqlite) [Next\\
\\
