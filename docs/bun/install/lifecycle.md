...
[`postinstall`](https://bun.com/docs/install/lifecycle#postinstall) [`trustedDependencies`](https://bun.com/docs/install/lifecycle#trusteddependencies) [`--ignore-scripts`](https://bun.com/docs/install/lifecycle#ignore-scripts)
...
[Previous\\
\\
Catalogs](https://bun.com/docs/install/catalogs) [Next\\
\\
