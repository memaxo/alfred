...
[Roadmap](https://bun.com/docs/project/roadmap) [Benchmarking](https://bun.com/docs/project/benchmarking) [Contributing](https://bun.com/docs/project/contributing) [Building Windows](https://bun.com/docs/project/building-windows) [Bindgen](https://bun.com/docs/project/bindgen)

[Creating JS Functions in Zig](https://bun.com/docs/project/bindgen#creating-js-functions-in-zig) [Strings](https://bun.com/docs/project/bindgen#strings) [Function Variants](https://bun.com/docs/project/bindgen#function-variants) [`t.dictionary`](https://bun.com/docs/project/bindgen#t-dictionary) [Enumerations](https://bun.com/docs/project/bindgen#enumerations) [Deriving enums from Zig code](https://bun.com/docs/project/bindgen#deriving-enums-from-zig-code) [`t.oneOf`](https://bun.com/docs/project/bindgen#t-oneof) [Attributes](https://bun.com/docs/project/bindgen#attributes) [Integer Attributes](https://bun.com/docs/project/bindgen#integer-attributes) [Callbacks](https://bun.com/docs/project/bindgen#callbacks) [Classes](https://bun.com/docs/project/bindgen#classes)
...
The new bindings generator, introduced to the codebase in Dec 2024, scans for `*.bind.ts` to find function and class definition, and generates glue code tointerop between JavaScript and native code.

There are currently other code generators and systems that achieve similarpurposes. The following will all eventually be completely phased out in favor ofthis one:
...
[Previous\\
\\
Building Windows](https://bun.com/docs/project/building-windows) [Next\\
\\
License](https://bun.com/docs/project/licensing)
