...
[What is Bun?](https://bun.com/docs/index) [Installation](https://bun.com/docs/installation) [Quickstart](https://bun.com/docs/quickstart)

[Run a file](https://bun.com/docs/quickstart#run-a-file) [Run a script](https://bun.com/docs/quickstart#run-a-script) [Install a package](https://bun.com/docs/quickstart#install-a-package)
...
[Previous\\
\\
Installation](https://bun.com/docs/installation) [Next\\
\\
TypeScript](https://bun.com/docs/typescript)
