...
[What is a runtime?](https://bun.com/docs#what-is-a-runtime) [Browsers](https://bun.com/docs#browsers) [Node.js](https://bun.com/docs#node-js) [Design goals](https://bun.com/docs#design-goals)

[Installation](https://bun.com/docs/installation) [Quickstart](https://bun.com/docs/quickstart) [TypeScript](https://bun.com/docs/typescript)
