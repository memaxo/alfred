...
## Decision Log
- Decided to interpret `MEMORY_DECAY_ENABLED` as a control for the *maintenance loop* specifically, rather than the entire worker, to allow learning to continue even if decay is paused.
