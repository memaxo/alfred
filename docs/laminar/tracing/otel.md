...
| --- | --- | --- | --- | --- |
| trace\_id | Unique identifier for the trace | 16-bytes | UUID \[1\] | `01234567-89ab-4def-0123-456789abcdef` |
| span\_id | Unique identifier for the span | 8-bytes | UUID \[1\] | `00000000-0000-0000-0123-456789abcdef` |
| parent\_span\_id | Unique identifier for the parent span | 8-bytes | UUID \[1\] | `00000000-0000-0000-0123-456789abcdef` |
...
| start\_time\_unix\_nano | Start time of the span in nanoseconds \[3\] | number | timestamp with UTC timezone | `1630000000000000000` |
| end\_time\_unix\_nano | End time of the span in nanoseconds \[3\] | number | timestamp with UTC timezone | `1630000000000000000` |
