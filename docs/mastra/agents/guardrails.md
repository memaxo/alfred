...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/agents/guardrails#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Agents](https://mastra.ai/en/docs/agents/overview "Agents") Guardrails
...
## When to use processors [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#when-to-use-processors)
...
## Adding processors to an agent [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#adding-processors-to-an-agent)
...
## Input processors [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#input-processors)
...
### Normalizing user messages [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#normalizing-user-messages)
...
> See [UnicodeNormalizer](https://mastra.ai/en/reference/processors/unicode-normalizer) for a full list of configuration options.

### Preventing prompt injection [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#preventing-prompt-injection)
...
> See [PromptInjectionDetector](https://mastra.ai/en/reference/processors/prompt-injection-detector) for a full list of configuration options.

### Detecting and translating language [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#detecting-and-translating-language)
...
> See [LanguageDetector](https://mastra.ai/en/reference/processors/language-detector) for a full list of configuration options.

## Output processors [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#output-processors)
...
### Batching streamed output [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#batching-streamed-output)
...
> See [BatchPartsProcessor](https://mastra.ai/en/reference/processors/batch-parts-processor) for a full list of configuration options.

### Limiting token usage [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#limiting-token-usage)
...
> See [TokenLimiterProcessor](https://mastra.ai/en/reference/processors/token-limiter-processor) for a full list of configuration options.

### Scrubbing system prompts [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#scrubbing-system-prompts)
...
> See [SystemPromptScrubber](https://mastra.ai/en/reference/processors/system-prompt-scrubber) for a full list of configuration options.

## Hybrid processors [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#hybrid-processors)
...
### Moderating input and output [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#moderating-input-and-output)
...
> See [ModerationProcessor](https://mastra.ai/en/reference/processors/moderation-processor) for a full list of configuration options.

### Detecting and redacting PII [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#detecting-and-redacting-pii)
...
> See [PIIDetector](https://mastra.ai/en/reference/processors/pii-detector) for a full list of configuration options.

## Applying multiple processors [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#applying-multiple-processors)
...
## Processor strategies [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#processor-strategies)
...
### Handling blocked requests [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#handling-blocked-requests)
...
#### `.generate()` example [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#generate-example)
...
#### `.stream()` example [Permalink for this section](https://mastra.ai/en/docs/agents/guardrails\#stream-example)
...
[Runtime Context](https://mastra.ai/en/docs/agents/runtime-context "Runtime Context") [Networks](https://mastra.ai/en/docs/agents/networks "Networks")