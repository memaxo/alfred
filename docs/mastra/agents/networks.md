...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/agents/networks#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Agents](https://mastra.ai/en/docs/agents/overview "Agents") Networks
...
## Differences from Workflows [Permalink for this section](https://mastra.ai/en/docs/agents/networks\#differences-from-workflows)
...
## Important details [Permalink for this section](https://mastra.ai/en/docs/agents/networks\#important-details)
...
## Turning an Agent into a Network [Permalink for this section](https://mastra.ai/en/docs/agents/networks\#turning-an-agent-into-a-network)
...
### How It Works [Permalink for this section](https://mastra.ai/en/docs/agents/networks\#how-it-works)
...
[Guardrails](https://mastra.ai/en/docs/agents/guardrails "Guardrails") [Adding Voice](https://mastra.ai/en/docs/agents/adding-voice "Adding Voice")