...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Deployment](https://mastra.ai/en/docs/deployment/overview "Deployment") [Cloud Providers](https://mastra.ai/en/docs/deployment/cloud-providers "Cloud Providers") Azure App Services
...
## Prerequisites [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#prerequisites)
...
## Deployment Steps [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#deployment-steps)

### Create a new App Service [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#create-a-new-app-service)
...
### Configure App Service settings [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#configure-app-service-settings)
...
### Wait for deployment [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#wait-for-deployment)

- Wait for the deployment to complete
- Once finished, click **Go to resource** under the next steps section

### Configure environment variables [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#configure-environment-variables)
...
### Set up GitHub deployment [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#set-up-github-deployment)
...
### Modify the GitHub workflow [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#modify-the-github-workflow)
...
### Deploy your changes [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#deploy-your-changes)
...
### Access your application [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#access-your-application)
...
## Connect to your Mastra server [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#connect-to-your-mastra-server)
...
## Next steps [Permalink for this section](https://mastra.ai/en/docs/deployment/cloud-providers/azure-app-services\#next-steps)
...
[Digital Ocean](https://mastra.ai/en/docs/deployment/cloud-providers/digital-ocean "Digital Ocean") [Overview](https://mastra.ai/en/docs/mastra-cloud/overview "Overview")