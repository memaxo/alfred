...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/memory/memory-processors#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Memory](https://mastra.ai/en/docs/memory/overview "Memory") Memory Processors
...
## Built-in Processors [Permalink for this section](https://mastra.ai/en/docs/memory/memory-processors\#built-in-processors)

Mastra provides built-in processors:

### `TokenLimiter` [Permalink for this section](https://mastra.ai/en/docs/memory/memory-processors\#tokenlimiter)
...
### `ToolCallFilter` [Permalink for this section](https://mastra.ai/en/docs/memory/memory-processors\#toolcallfilter)
...
## Applying Multiple Processors [Permalink for this section](https://mastra.ai/en/docs/memory/memory-processors\#applying-multiple-processors)
...
## Creating Custom Processors [Permalink for this section](https://mastra.ai/en/docs/memory/memory-processors\#creating-custom-processors)
...
[Semantic Recall](https://mastra.ai/en/docs/memory/semantic-recall "Semantic Recall") [Overview](https://mastra.ai/en/docs/rag/overview "Overview")