...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/observability/ai-tracing/overview#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Observability](https://mastra.ai/en/docs/observability/overview "Observability") AI TracingOverview
...
## How It Works [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#how-it-works)
...
## Configuration [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#configuration)

### Basic Config [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#basic-config)
...
### Expanded Basic Config [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#expanded-basic-config)
...
## Exporters [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#exporters)
...
### Internal Exporters [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#internal-exporters)

Mastra provides two built-in exporters that work out of the box:

- **[Default](https://mastra.ai/docs/observability/ai-tracing/exporters/default)** \- Persists traces to local storage for viewing in the Playground
- **[Cloud](https://mastra.ai/docs/observability/ai-tracing/exporters/cloud)** \- Sends traces to Mastra Cloud for production monitoring and collaboration

### External Exporters [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#external-exporters)
...
- **[Braintrust](https://mastra.ai/docs/observability/ai-tracing/exporters/braintrust)** \- Exports traces to Braintrust’s eval and observability platform

- **[Langfuse](https://mastra.ai/docs/observability/ai-tracing/exporters/langfuse)** \- Sends traces to the Langfuse open-source LLM engineering platform

- **[LangSmith](https://mastra.ai/docs/observability/ai-tracing/exporters/langsmith)** \- Pushes traces into LangSmith’s observability and evaluation toolkit

- **[OpenTelemetry](https://mastra.ai/docs/observability/ai-tracing/exporters/otel)** \- Deliver traces to any OpenTelemetry-compatible observability system
  - Supports: Dash0, Laminar, New Relic, SigNoz, Traceloop, Zipkin, and others!
- **Arize** \- Coming soon!


## Sampling Strategies [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#sampling-strategies)
...
### Always Sample [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#always-sample)
...
### Never Sample [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#never-sample)
...
### Ratio-Based Sampling [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#ratio-based-sampling)
...
### Custom Sampling [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#custom-sampling)
...
### Complete Example [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#complete-example)
...
## Multi-Config Setup [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#multi-config-setup)
...
### Dynamic Configuration Selection [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#dynamic-configuration-selection)
...
### Environment-Based Configuration [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#environment-based-configuration)
...
### Common Configuration Patterns & Troubleshooting [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#common-configuration-patterns--troubleshooting)

#### Default Config Takes Priority [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#default-config-takes-priority)
...
#### Maintaining Playground and Cloud Access [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#maintaining-playground-and-cloud-access)
...
## Adding Custom Metadata [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#adding-custom-metadata)
...
## Creating Child Spans [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#creating-child-spans)
...
## Span Processors [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#span-processors)
...
### Built-in Processors [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#built-in-processors)

- [Sensitive Data Filter](https://mastra.ai/docs/observability/ai-tracing/processors/sensitive-data-filter) redacts sensitive information. It is enabled in the default observability config.

### Creating Custom Processors [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#creating-custom-processors)
...
## Retrieving Trace IDs [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#retrieving-trace-ids)
...
### Agent Trace IDs [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#agent-trace-ids)
...
### Workflow Trace IDs [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#workflow-trace-ids)
...
### Using Trace IDs [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#using-trace-ids)
...
## What Gets Traced [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#what-gets-traced)

Mastra automatically creates spans for:

### Agent Operations [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#agent-operations)
...
### Workflow Operations [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#workflow-operations)
...
## Viewing Traces [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#viewing-traces)
...
## See Also [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#see-also)

### Examples [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#examples)

- [Basic AI Tracing Example](https://mastra.ai/examples/observability/basic-ai-tracing) \- Working implementation

### Reference Documentation [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#reference-documentation)

- [Configuration API](https://mastra.ai/reference/observability/ai-tracing/configuration) \- ObservabilityConfig details
- [AITracing Classes](https://mastra.ai/reference/observability/ai-tracing/ai-tracing) \- Core classes and methods
- [Span Interfaces](https://mastra.ai/reference/observability/ai-tracing/span) \- Span types and lifecycle
- [Type Definitions](https://mastra.ai/reference/observability/ai-tracing/interfaces) \- Complete interface reference

### Exporters [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#exporters-1)

- [DefaultExporter](https://mastra.ai/reference/observability/ai-tracing/exporters/default-exporter) \- Storage persistence
- [CloudExporter](https://mastra.ai/reference/observability/ai-tracing/exporters/cloud-exporter) \- Mastra Cloud integration
- [ConsoleExporter](https://mastra.ai/reference/observability/ai-tracing/exporters/console-exporter) \- Debug output
- [Langfuse](https://mastra.ai/reference/observability/ai-tracing/exporters/langfuse) \- Langfuse integration
- [Braintrust](https://mastra.ai/reference/observability/ai-tracing/exporters/braintrust) \- Braintrust integration
- [OpenTelemetry](https://mastra.ai/reference/observability/ai-tracing/exporters/otel) \- OTEL-compatible platforms

### Processors [Permalink for this section](https://mastra.ai/en/docs/observability/ai-tracing/overview\#processors)

- [Sensitive Data Filter](https://mastra.ai/docs/observability/ai-tracing/processors/sensitive-data-filter) \- Data redaction

[Logging](https://mastra.ai/en/docs/observability/logging "Logging") [Default](https://mastra.ai/en/docs/observability/ai-tracing/exporters/default "Default")