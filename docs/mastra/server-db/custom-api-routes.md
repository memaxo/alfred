...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/server-db/custom-api-routes#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Server & DB](https://mastra.ai/en/docs/server-db/local-dev-playground "Server & DB") Custom API Routes
...
[Middleware](https://mastra.ai/en/docs/server-db/middleware "Middleware") [Storage](https://mastra.ai/en/docs/server-db/storage "Storage")