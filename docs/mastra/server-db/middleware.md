...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/server-db/middleware#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Server & DB](https://mastra.ai/en/docs/server-db/local-dev-playground "Server & DB") Middleware
...
## Common examples [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#common-examples)

### Authentication [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#authentication)
...
### CORS support [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#cors-support)
...
### Request logging [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#request-logging)
...
### Special Mastra headers [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#special-mastra-headers)
...
### Setting `runtimeContext` [Permalink for this section](https://mastra.ai/en/docs/server-db/middleware\#setting-runtimecontext)
...
[Production Server](https://mastra.ai/en/docs/server-db/production-server "Production Server") [Custom API Routes](https://mastra.ai/en/docs/server-db/custom-api-routes "Custom API Routes")