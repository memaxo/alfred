...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/server-db/snapshots#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Server & DB](https://mastra.ai/en/docs/server-db/local-dev-playground "Server & DB") Snapshots
...
## The role of snapshots in suspend and resume [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#the-role-of-snapshots-in-suspend-and-resume)
...
## Snapshot anatomy [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#snapshot-anatomy)
...
## How snapshots are saved and retrieved [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#how-snapshots-are-saved-and-retrieved)
...
- [LibSQL Storage](https://mastra.ai/en/reference/storage/libsql)
- [Upstash Storage](https://mastra.ai/en/reference/storage/upstash)
- [PostgreSQL Storage](https://mastra.ai/en/reference/storage/postgresql)

### Saving snapshots [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#saving-snapshots)
...
### Retrieving snapshots [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#retrieving-snapshots)
...
## Storage options for snapshots [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#storage-options-for-snapshots)
...
### LibSQL `@mastra/libsql` [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#libsql-mastralibsql)
...
### Upstash `@mastra/upstash` [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#upstash-mastraupstash)
...
### Postgres `@mastra/pg` [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#postgres-mastrapg)
...
## Best practices [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#best-practices)
...
## Custom snapshot metadata [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#custom-snapshot-metadata)
...
### Providing resume data [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#providing-resume-data)
...
## Related [Permalink for this section](https://mastra.ai/en/docs/server-db/snapshots\#related)

- [Suspend and resume](https://mastra.ai/en/docs/workflows/suspend-and-resume)
- [Human in the loop example](https://mastra.ai/en/examples/workflows/human-in-the-loop)
- [WorkflowRun.watch()](https://mastra.ai/en/reference/workflows/run-methods/watch)

[Storage](https://mastra.ai/en/docs/server-db/storage "Storage") [Mastra Client](https://mastra.ai/en/docs/server-db/mastra-client "Mastra Client")