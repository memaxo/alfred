...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/streaming/workflow-streaming#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Streamingexp.](https://mastra.ai/en/docs/streaming/overview "Streaming") Workflow Streaming
...
### Using the `writer` argument [Permalink for this section](https://mastra.ai/en/docs/streaming/workflow-streaming\#using-the-writer-argument)
...
### Inspecting workflow stream payloads [Permalink for this section](https://mastra.ai/en/docs/streaming/workflow-streaming\#inspecting-workflow-stream-payloads)
...
### Resuming an interrupted workflow stream [Permalink for this section](https://mastra.ai/en/docs/streaming/workflow-streaming\#resuming-an-interrupted-workflow-stream)
...
## Workflow using an agent [Permalink for this section](https://mastra.ai/en/docs/streaming/workflow-streaming\#workflow-using-an-agent)
...
[Tool Streaming](https://mastra.ai/en/docs/streaming/tool-streaming "Tool Streaming") [Overview](https://mastra.ai/en/docs/tools-mcp/overview "Overview")