...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/tools-mcp/advanced-usage#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Tools & MCP](https://mastra.ai/en/docs/tools-mcp/overview "Tools & MCP") Advanced Usage
...
## Abort Signals [Permalink for this section](https://mastra.ai/en/docs/tools-mcp/advanced-usage\#abort-signals)
...
## AI SDK Tool Format [Permalink for this section](https://mastra.ai/en/docs/tools-mcp/advanced-usage\#ai-sdk-tool-format)
...
[Runtime Context](https://mastra.ai/en/docs/tools-mcp/runtime-context "Runtime Context") [Overview](https://mastra.ai/en/docs/memory/overview "Overview")