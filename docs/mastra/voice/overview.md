...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/voice/overview#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") VoiceOverview
...
## Adding Voice to Agents [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#adding-voice-to-agents)

To learn how to integrate voice capabilities into your agents, check out the [Adding Voice to Agents](https://mastra.ai/en/docs/agents/adding-voice) documentation. This section covers how to use both single and multiple voice providers, as well as real-time interactions.
...
### Text to Speech (TTS) [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#text-to-speech-tts)
...
For detailed configuration options and advanced features, check out our [Text-to-Speech guide](https://mastra.ai/en/docs/voice/text-to-speech).

OpenAIAzureElevenLabsPlayAIGoogleCloudflareDeepgramSpeechifySarvamMurf
...
### Speech to Text (STT) [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#speech-to-text-stt)

Transcribe spoken content using various providers like OpenAI, ElevenLabs, and more. For detailed configuration options and more, check out [Speech to Text](https://mastra.ai/en/docs/voice/speech-to-text).
...
OpenAIAzureElevenLabsGoogleCloudflareDeepgramSarvam
...
### Speech to Speech (STS) [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#speech-to-speech-sts)
...
For detailed configuration options and advanced features, check out [Speech to Speech](https://mastra.ai/en/docs/voice/speech-to-speech).

OpenAIGoogle Gemini Live
...
## Voice Configuration [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#voice-configuration)
...
OpenAIAzureElevenLabsPlayAIGoogleCloudflareDeepgramSpeechifySarvamMurfOpenAI RealtimeGoogle Gemini Live
...
### Using Multiple Voice Providers [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#using-multiple-voice-providers)
...
## More Resources [Permalink for this section](https://mastra.ai/en/docs/voice/overview\#more-resources)

- [CompositeVoice](https://mastra.ai/en/reference/voice/composite-voice)
- [MastraVoice](https://mastra.ai/en/reference/voice/mastra-voice)
- [OpenAI Voice](https://mastra.ai/en/reference/voice/openai)
- [OpenAI Realtime Voice](https://mastra.ai/en/reference/voice/openai-realtime)
- [Azure Voice](https://mastra.ai/en/reference/voice/azure)
- [Google Voice](https://mastra.ai/en/reference/voice/google)
- [Google Gemini Live Voice](https://mastra.ai/en/reference/voice/google-gemini-live)
- [Deepgram Voice](https://mastra.ai/en/reference/voice/deepgram)
- [PlayAI Voice](https://mastra.ai/en/reference/voice/playai)
- [Voice Examples](https://mastra.ai/en/examples/voice/text-to-speech)

[Auth0](https://mastra.ai/en/docs/auth/auth0 "Auth0") [Text to Speech](https://mastra.ai/en/docs/voice/text-to-speech "Text to Speech")