...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/voice/speech-to-speech#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Voice](https://mastra.ai/en/docs/voice/overview "Voice") Speech to Speechnew

Copy page

# Speech-to-Speech Capabilities in Mastra

## Introduction [Permalink for this section](https://mastra.ai/en/docs/voice/speech-to-speech\#introduction)
...
## Configuration [Permalink for this section](https://mastra.ai/en/docs/voice/speech-to-speech\#configuration)
...
## Using STS [Permalink for this section](https://mastra.ai/en/docs/voice/speech-to-speech\#using-sts)
...
For integrating Speech-to-Speech capabilities with agents, refer to the [Adding Voice to Agents](https://mastra.ai/en/docs/agents/adding-voice) documentation.

## Google Gemini Live (Realtime) [Permalink for this section](https://mastra.ai/en/docs/voice/speech-to-speech\#google-gemini-live-realtime)
...
[Speech to Text](https://mastra.ai/en/docs/voice/speech-to-text "Speech to Text") [With Vercel AI SDK](https://mastra.ai/en/docs/frameworks/agentic-uis/ai-sdk "With Vercel AI SDK")