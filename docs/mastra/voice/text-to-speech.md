...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/voice/text-to-speech#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Voice](https://mastra.ai/en/docs/voice/overview "Voice") Text to Speech
...
TTS is a core component of any voice application. Combined with STT (Speech-to-Text), it forms the foundation of voice interaction systems. Newer models support STS ( [Speech-to-Speech](https://mastra.ai/en/docs/voice/speech-to-speech)) which can be used for real-time interactions but come at high cost ($).

## Configuration [Permalink for this section](https://mastra.ai/en/docs/voice/text-to-speech\#configuration)
...
## Available Providers [Permalink for this section](https://mastra.ai/en/docs/voice/text-to-speech\#available-providers)
...
## Using the Speak Method [Permalink for this section](https://mastra.ai/en/docs/voice/text-to-speech\#using-the-speak-method)
...
Check out the [Adding Voice to Agents](https://mastra.ai/en/docs/agents/adding-voice) documentation to learn how to use TTS in an agent.

[Overview](https://mastra.ai/en/docs/voice/overview "Overview") [Speech to Text](https://mastra.ai/en/docs/voice/speech-to-text "Speech to Text")