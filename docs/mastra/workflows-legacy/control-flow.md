...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/control-flow#nextra-skip-nav)
...
## Parallel Execution [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#parallel-execution)
...
See the [Parallel Steps](https://mastra.ai/en/examples/workflows_legacy/parallel-steps) example for more details.

## Sequential Execution [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#sequential-execution)
...
See the [Sequential Steps](https://mastra.ai/en/examples/workflows_legacy/sequential-steps) example for more details.

## Branching and Merging Paths [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#branching-and-merging-paths)
...
See the [Branching Paths](https://mastra.ai/en/examples/workflows_legacy/branching-paths) example for more details.

## Merging Multiple Branches [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#merging-multiple-branches)
...
## Cyclical Dependencies and Loops [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#cyclical-dependencies-and-loops)
...
### Using Manual Cyclical Dependencies (Legacy Approach) [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-manual-cyclical-dependencies-legacy-approach)
...
### Using `until` for Condition-Based Loops [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-until-for-condition-based-loops)
...
### Using `while` for Condition-Based Loops [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-while-for-condition-based-loops)
...
### Comparison Operators for Reference Conditions [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#comparison-operators-for-reference-conditions)
...
## Conditions [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#conditions)
...
### Option 1: Function [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#option-1-function)
...
### Option 2: Query Object [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#option-2-query-object)
...
### Option 3: Simple Path Comparison [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#option-3-simple-path-comparison)
...
## Data Access Patterns [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#data-access-patterns)
...
### Using getStepResult Method [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-getstepresult-method)
...
#### Basic Usage [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#basic-usage)
...
#### Using Step References [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-step-references)
...
### Using Variable Mapping [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-variable-mapping)
...
For more details on variable mapping, see the [Data Mapping with Workflow Variables](https://mastra.ai/en/docs/workflows-legacy/variables) documentation.

### Using the Context Object [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#using-the-context-object)
...
### Workflow-Level Type Safety [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#workflow-level-type-safety)
...
### Accessing Trigger Data [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#accessing-trigger-data)
...
### Accessing Resume Data [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#accessing-resume-data)
...
### Accessing Workflow Results [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#accessing-workflow-results)
...
### Best Practices for Data Flow [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#best-practices-for-data-flow)
...
### Comparison of Data Flow Methods [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/control-flow\#comparison-of-data-flow-methods)
