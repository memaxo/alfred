...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows#nextra-skip-nav)
...
## Overview [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#overview)

Dynamic workflows are useful when you need to create workflows based on runtime data.

## Implementation [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#implementation)
...
### Basic Example [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#basic-example)
...
## Advanced Example: Workflow Factory [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#advanced-example-workflow-factory)
...
## Important Considerations [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#important-considerations)
...
## Use Cases [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#use-cases)
...
## Conclusion [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/dynamic-workflows\#conclusion)
