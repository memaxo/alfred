...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/nested-workflows#nextra-skip-nav)
...
## Basic Usage [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#basic-usage)
...
## Accessing Results [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#accessing-results)
...
## Control Flow with Nested Workflows [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#control-flow-with-nested-workflows)

Nested workflows support all the control flow features available to regular steps:

### Parallel Execution [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#parallel-execution)
...
### If-Else Branching [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#if-else-branching)
...
### Looping [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#looping)
...
## Watching Nested Workflows [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#watching-nested-workflows)
...
## Suspending and Resuming [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#suspending-and-resuming)
...
## Result Schemas and Mapping [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#result-schemas-and-mapping)
...
## Best Practices [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#best-practices)
...
## Example [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/nested-workflows\#example)
