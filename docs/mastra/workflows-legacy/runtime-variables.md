...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/runtime-variables#nextra-skip-nav)
...
## Overview [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#overview)
...
## Basic Usage [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#basic-usage)
...
## Using with REST API [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#using-with-rest-api)
...
## Creating Steps with Variables [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#creating-steps-with-variables)
...
## Error Handling [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#error-handling)
...
## Best Practices [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/runtime-variables\#best-practices)
