...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/steps#nextra-skip-nav)
...
## Inline Step Creation [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/steps\#inline-step-creation)
...
## Creating Steps Separately [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/steps\#creating-steps-separately)
