...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume#nextra-skip-nav)
...
## When to Use Suspend/Resume [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#when-to-use-suspendresume)
...
## Basic Suspend Example [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#basic-suspend-example)
...
## Async/Await Based Flow [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#asyncawait-based-flow)
...
### How It Works [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#how-it-works)
...
### Example with Multiple Suspension Points [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#example-with-multiple-suspension-points)
...
### Starting and Resuming the Workflow [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#starting-and-resuming-the-workflow)
...
## Event-Based Suspension and Resumption [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#event-based-suspension-and-resumption)
...
### Using afterEvent and resumeWithEvent [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#using-afterevent-and-resumewithevent)
...
### Example: Event-Based Workflow [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#example-event-based-workflow)
...
### Running an Event-Based Workflow [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#running-an-event-based-workflow)
...
### Key Points About Event-Based Workflows [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#key-points-about-event-based-workflows)
...
## Storage for Suspend and Resume [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#storage-for-suspend-and-resume)
...
### Default Storage: LibSQL [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#default-storage-libsql)
...
### Alternative Storage Options [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#alternative-storage-options)

#### Upstash (Redis-Compatible) [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#upstash-redis-compatible)
...
### Storage Considerations [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#storage-considerations)
...
## Watching and Resuming [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#watching-and-resuming)
...
### Watching and Resuming Event-Based Workflows [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#watching-and-resuming-event-based-workflows)
...
## Further Reading [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#further-reading)

For a deeper understanding of how suspend and resume works under the hood:

- [Understanding Snapshots in Mastra Workflows](https://mastra.ai/en/reference/legacyWorkflows/snapshots) \- Learn about the snapshot mechanism that powers suspend and resume functionality
- [Step Configuration Guide](https://mastra.ai/en/docs/workflows-legacy/steps) \- Learn more about configuring steps in your workflows
- [Control Flow Guide](https://mastra.ai/en/docs/workflows-legacy/control-flow) \- Advanced workflow control patterns
- [Event-Driven Workflows](https://mastra.ai/en/reference/legacyWorkflows/events) \- Detailed reference for event-based workflows

## Related Resources [Permalink for this section](https://mastra.ai/en/docs/workflows-legacy/suspend-and-resume\#related-resources)

- See the [Suspend and Resume Example](https://mastra.ai/en/examples/workflows_legacy/suspend-and-resume) for a complete working example
- Check the [Step Class Reference](https://mastra.ai/en/reference/legacyWorkflows/step-class) for suspend/resume API details
- Review [Workflow Observability](https://mastra.ai/en/reference/observability/otel-config) for monitoring suspended workflows
