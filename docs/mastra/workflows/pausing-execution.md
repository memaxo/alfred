...
language: en
---
[Skip to Content](https://mastra.ai/en/docs/workflows/pausing-execution#nextra-skip-nav)

[Docs](https://mastra.ai/en/docs "Docs") [Workflows](https://mastra.ai/en/docs/workflows/overview "Workflows") Sleep & Events
...
## Pausing with `.sleep()` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#pausing-with-sleep)
...
### Pausing with `.sleep(callback)` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#pausing-with-sleepcallback)
...
## Pausing with `.sleepUntil()` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#pausing-with-sleepuntil)
...
### Pausing with `.sleepUntil(callback)` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#pausing-with-sleepuntilcallback)
...
## Pausing with `.waitForEvent()` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#pausing-with-waitforevent)
...
![Pausing with .waitForEvent()](https://mastra.ai/_next/image?url=%2Fdocs%2F_next%2Fstatic%2Fmedia%2Fworkflows-sleep-events-waitforevent.bf4da799.jpg&w=3840&q=75)
...
## Sending an event with `.sendEvent()` [Permalink for this section](https://mastra.ai/en/docs/workflows/pausing-execution\#sending-an-event-with-sendevent)
...
[Suspend & Resume](https://mastra.ai/en/docs/workflows/suspend-and-resume "Suspend & Resume") [Error Handling](https://mastra.ai/en/docs/workflows/error-handling "Error Handling")