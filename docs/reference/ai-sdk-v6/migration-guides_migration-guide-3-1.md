Migration GuidesMigrate AI SDK 3.0 to 3.1
...
With AI SDK Core you have a unified API for any provider that implements the AI SDK Language Model Specification.
