...
[Previous Page\\
\\
Adapters](https://www.better-auth.com/docs/adapters/drizzle) [Next Page\\
\\
Prisma](https://www.better-auth.com/docs/adapters/prisma)

### On this page

[Example Usage](https://www.better-auth.com/docs/adapters/drizzle#example-usage) [Schema generation & migration](https://www.better-auth.com/docs/adapters/drizzle#schema-generation--migration) [Additional Information](https://www.better-auth.com/docs/adapters/drizzle#additional-information)
