...
[Edit on GitHub](https://github.com/better-auth/better-auth/blob/main/docs/content/docs/concepts/oauth.mdx)

[Previous Page\\
\\
Plugins](https://www.better-auth.com/docs/concepts/plugins) [Next Page\\
\\
Rate Limit](https://www.better-auth.com/docs/concepts/rate-limit)

### On this page

[Configuring Social Providers](https://www.better-auth.com/docs/concepts/oauth#configuring-social-providers) [Usage](https://www.better-auth.com/docs/concepts/oauth#usage) [Sign In](https://www.better-auth.com/docs/concepts/oauth#sign-in) [Link account](https://www.better-auth.com/docs/concepts/oauth#link-account) [Get Access Token](https://www.better-auth.com/docs/concepts/oauth#get-access-token) [Get Account Info Provided by the provider](https://www.better-auth.com/docs/concepts/oauth#get-account-info-provided-by-the-provider) [Requesting Additional Scopes](https://www.better-auth.com/docs/concepts/oauth#requesting-additional-scopes) [Other Provider Configurations](https://www.better-auth.com/docs/concepts/oauth#other-provider-configurations) [How OAuth Works in Better Auth](https://www.better-auth.com/docs/concepts/oauth#how-oauth-works-in-better-auth) [Post-Login Flow](https://www.better-auth.com/docs/concepts/oauth#post-login-flow)
