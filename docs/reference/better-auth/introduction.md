...
## [LLMs.txt](https://www.better-auth.com/docs/introduction#llmstxt)
...
[Why Better Auth?](https://www.better-auth.com/docs/introduction#why-better-auth) [Features](https://www.better-auth.com/docs/introduction#features) [LLMs.txt](https://www.better-auth.com/docs/introduction#llmstxt)
