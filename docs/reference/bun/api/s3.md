---
title: S3 Object Storage – API | Bun Docs
url:
...
[Basic Usage](https://bun.com/docs/api/s3#basic-usage) [`Bun.S3Client` & `Bun.s3`](https://bun.com/docs/api/s3#bun-s3client-bun-s3) [Working with S3 Files](https://bun.com/docs/api/s3#working-with-s3-files) [Reading files from S3](https://bun.com/docs/api/s3#reading-files-from-s3) [Writing & uploading files to S3](https://bun.com/docs/api/s3#writing-uploading-files-to-s3) [Working with large files (streams)](https://bun.com/docs/api/s3#working-with-large-files-streams) [Presigning URLs](https://bun.com/docs/api/s3#presigning-urls) [Setting ACLs](https://bun.com/docs/api/s3#setting-acls) [Expiring URLs](https://bun.com/docs/api/s3#expiring-urls) [`method`](https://bun.com/docs/api/s3#method) [`new Response(S3File)`](https://bun.com/docs/api/s3#new-response-s3file) [Support for S3-Compatible Services](https://bun.com/docs/api/s3#support-for-s3-compatible-services) [Using Bun's S3Client with AWS S3](https://bun.com/docs/api/s3#using-bun-s-s3client-with-aws-s3) [Using Bun's S3Client with Google Cloud Storage](https://bun.com/docs/api/s3#using-bun-s-s3client-with-google-cloud-storage) [Using Bun's S3Client with Cloudflare R2](https://bun.com/docs/api/s3#using-bun-s-s3client-with-cloudflare-r2) [Using Bun's S3Client with DigitalOcean Spaces](https://bun.com/docs/api/s3#using-bun-s-s3client-with-digitalocean-spaces) [Using Bun's S3Client with MinIO](https://bun.com/docs/api/s3#using-bun-s-s3client-with-minio) [Using Bun's S3Client with supabase](https://bun.com/docs/api/s3#using-bun-s-s3client-with-supabase) [Using Bun's S3Client with S3 Virtual Hosted-Style endpoints](https://bun.com/docs/api/s3#using-bun-s-s3client-with-s3-virtual-hosted-style-endpoints) [Credentials](https://bun.com/docs/api/s3#credentials) [`S3Client` objects](https://bun.com/docs/api/s3#s3client-objects) [`S3Client.prototype.write`](https://bun.com/docs/api/s3#s3client-prototype-write) [`S3Client.prototype.delete`](https://bun.com/docs/api/s3#s3client-prototype-delete) [`S3Client.prototype.exists`](https://bun.com/docs/api/s3#s3client-prototype-exists) [`S3File`](https://bun.com/docs/api/s3#s3file) [Partial reads with `slice`](https://bun.com/docs/api/s3#partial-reads-with-slice) [Deleting files from S3](https://bun.com/docs/api/s3#deleting-files-from-s3) [Error codes](https://bun.com/docs/api/s3#error-codes) [`S3Client` static methods](https://bun.com/docs/api/s3#s3client-static-methods) [`S3Client.write` (static)](https://bun.com/docs/api/s3#s3client-write-static) [`S3Client.presign` (static)](https://bun.com/docs/api/s3#s3client-presign-static) [`S3Client.list` (static)](https://bun.com/docs/api/s3#s3client-list-static) [`S3Client.exists` (static)](https://bun.com/docs/api/s3#s3client-exists-static) [`S3Client.size` (static)](https://bun.com/docs/api/s3#s3client-size-static) [`S3Client.stat` (static)](https://bun.com/docs/api/s3#s3client-stat-static) [`S3Client.delete` (static)](https://bun.com/docs/api/s3#s3client-delete-static) [`s3://` protocol](https://bun.com/docs/api/s3#s3-protocol) [UTF-8, UTF-16, and BOM (byte order mark)](https://bun.com/docs/api/s3#utf-8-utf-16-and-bom-byte-order-mark)

[File I/O](https://bun.com/docs/api/file-io) [Redis client](https://bun.com/docs/api/redis) [import.meta](https://bun.com/docs/api/import-meta) [SQLite](https://bun.com/docs/api/sqlite) [FileSystemRouter](https://bun.com/docs/api/file-system-router) [TCP sockets](https://bun.com/docs/api/tcp) [UDP sockets](https://bun.com/docs/api/udp) [Globals](https://bun.com/docs/api/globals) [$ Shell](https://bun.com/docs/runtime/shell) [Child processes](https://bun.com/docs/api/spawn) [YAML](https://bun.com/docs/api/yaml) [HTMLRewriter](https://bun.com/docs/api/html-rewriter) [Hashing](https://bun.com/docs/api/hashing) [Console](https://bun.com/docs/api/console) [Cookie](https://bun.com/docs/api/cookie) [FFI](https://bun.com/docs/api/ffi) [C Compiler](https://bun.com/docs/api/cc) [Secrets](https://bun.com/docs/api/secrets) [Testing](https://bun.com/docs/cli/test) [Utils](https://bun.com/docs/api/utils) [Node-API](https://bun.com/docs/api/node-api) [Glob](https://bun.com/docs/api/glob) [DNS](https://bun.com/docs/api/dns) [Semver](https://bun.com/docs/api/semver) [Color](https://bun.com/docs/api/color) [Transpiler](https://bun.com/docs/api/transpiler)
...
### [Bun's S3 API is fast](https://bun.com/docs/api/s3#bun-s-s3-api-is-fast)

[![Bun's S3 API is fast](https://bun.com/bun-s3-node.gif)](https://bun.com/bun-s3-node.gif) Left: Bun v1.1.44. Right: Node.js v23.6.0
...
## [Basic Usage](https://bun.com/docs/api/s3#basic-usage)

There are several ways to interact with Bun's S3 API.

### [`Bun.S3Client` & `Bun.s3`](https://bun.com/docs/api/s3#bun-s3client-bun-s3)
...
### [Working with S3 Files](https://bun.com/docs/api/s3#working-with-s3-files)
...
### [Reading files from S3](https://bun.com/docs/api/s3#reading-files-from-s3)
...
### [Writing & uploading files to S3](https://bun.com/docs/api/s3#writing-uploading-files-to-s3)
...
### [Working with large files (streams)](https://bun.com/docs/api/s3#working-with-large-files-streams)
...
## [Presigning URLs](https://bun.com/docs/api/s3#presigning-urls)
...
### [Setting ACLs](https://bun.com/docs/api/s3#setting-acls)
...
### [Expiring URLs](https://bun.com/docs/api/s3#expiring-urls)
...
### [`method`](https://bun.com/docs/api/s3#method)
...
### [`new Response(S3File)`](https://bun.com/docs/api/s3#new-response-s3file)
...
## [Support for S3-Compatible Services](https://bun.com/docs/api/s3#support-for-s3-compatible-services)

Bun's S3 implementation works with any S3-compatible storage service. Just specify the appropriate endpoint:

### [Using Bun's S3Client with AWS S3](https://bun.com/docs/api/s3#using-bun-s-s3client-with-aws-s3)
...
### [Using Bun's S3Client with Google Cloud Storage](https://bun.com/docs/api/s3#using-bun-s-s3client-with-google-cloud-storage)
...
### [Using Bun's S3Client with Cloudflare R2](https://bun.com/docs/api/s3#using-bun-s-s3client-with-cloudflare-r2)
...
### [Using Bun's S3Client with DigitalOcean Spaces](https://bun.com/docs/api/s3#using-bun-s-s3client-with-digitalocean-spaces)
...
### [Using Bun's S3Client with MinIO](https://bun.com/docs/api/s3#using-bun-s-s3client-with-minio)
...
### [Using Bun's S3Client with supabase](https://bun.com/docs/api/s3#using-bun-s-s3client-with-supabase)
...
### [Using Bun's S3Client with S3 Virtual Hosted-Style endpoints](https://bun.com/docs/api/s3#using-bun-s-s3client-with-s3-virtual-hosted-style-endpoints)
...
## [Credentials](https://bun.com/docs/api/s3#credentials)
...
These environment variables are read from [`.env` files](https://bun.com/docs/runtime/env) or from the process environment at initialization time ( `process.env` is not used for this).
...
### [`S3Client` objects](https://bun.com/docs/api/s3#s3client-objects)
...
### [`S3Client.prototype.write`](https://bun.com/docs/api/s3#s3client-prototype-write)
...
### [`S3Client.prototype.delete`](https://bun.com/docs/api/s3#s3client-prototype-delete)
...
### [`S3Client.prototype.exists`](https://bun.com/docs/api/s3#s3client-prototype-exists)
...
## [`S3File`](https://bun.com/docs/api/s3#s3file)
...
### [Partial reads with `slice`](https://bun.com/docs/api/s3#partial-reads-with-slice)
...
### [Deleting files from S3](https://bun.com/docs/api/s3#deleting-files-from-s3)
...
## [Error codes](https://bun.com/docs/api/s3#error-codes)
...
## [`S3Client` static methods](https://bun.com/docs/api/s3#s3client-static-methods)

The `S3Client` class provides several static methods for interacting with S3.

### [`S3Client.write` (static)](https://bun.com/docs/api/s3#s3client-write-static)
...
### [`S3Client.presign` (static)](https://bun.com/docs/api/s3#s3client-presign-static)
...
### [`S3Client.list` (static)](https://bun.com/docs/api/s3#s3client-list-static)
...
### [`S3Client.exists` (static)](https://bun.com/docs/api/s3#s3client-exists-static)
...
### [`S3Client.size` (static)](https://bun.com/docs/api/s3#s3client-size-static)
...
### [`S3Client.stat` (static)](https://bun.com/docs/api/s3#s3client-stat-static)
...
### [`S3Client.delete` (static)](https://bun.com/docs/api/s3#s3client-delete-static)
...
## [`s3://` protocol](https://bun.com/docs/api/s3#s3-protocol)
...
### [UTF-8, UTF-16, and BOM (byte order mark)](https://bun.com/docs/api/s3#utf-8-utf-16-and-bom-byte-order-mark)
...
[Previous\\
\\
SQL](https://bun.com/docs/api/sql) [Next\\
\\
File I/O](https://bun.com/docs/api/file-io)

[![GitHub logo](Base64-Image-Removed)![GitHub logo](Base64-Image-Removed)\\
\\
Edit on GitHub](https://github.com/oven-sh/bun/edit/main/docs/api/s3.md)
