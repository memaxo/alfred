...
[Spawn a process ( `Bun.spawn()`)](https://bun.com/docs/api/spawn#spawn-a-process-bun-spawn) [Input stream](https://bun.com/docs/api/spawn#input-stream) [Output streams](https://bun.com/docs/api/spawn#output-streams) [Exit handling](https://bun.com/docs/api/spawn#exit-handling) [Resource usage](https://bun.com/docs/api/spawn#resource-usage) [Using AbortSignal](https://bun.com/docs/api/spawn#using-abortsignal) [Using timeout and killSignal](https://bun.com/docs/api/spawn#using-timeout-and-killsignal) [Using maxBuffer](https://bun.com/docs/api/spawn#using-maxbuffer) [Inter-process communication (IPC)](https://bun.com/docs/api/spawn#inter-process-communication-ipc) [IPC between Bun & Node.js](https://bun.com/docs/api/spawn#ipc-between-bun-node-js) [Blocking API ( `Bun.spawnSync()`)](https://bun.com/docs/api/spawn#blocking-api-bun-spawnsync) [Benchmarks](https://bun.com/docs/api/spawn#benchmarks) [Reference](https://bun.com/docs/api/spawn#reference)

[YAML](https://bun.com/docs/api/yaml) [HTMLRewriter](https://bun.com/docs/api/html-rewriter) [Hashing](https://bun.com/docs/api/hashing) [Console](https://bun.com/docs/api/console) [Cookie](https://bun.com/docs/api/cookie) [FFI](https://bun.com/docs/api/ffi) [C Compiler](https://bun.com/docs/api/cc) [Secrets](https://bun.com/docs/api/secrets) [Testing](https://bun.com/docs/cli/test) [Utils](https://bun.com/docs/api/utils) [Node-API](https://bun.com/docs/api/node-api) [Glob](https://bun.com/docs/api/glob) [DNS](https://bun.com/docs/api/dns) [Semver](https://bun.com/docs/api/semver) [Color](https://bun.com/docs/api/color) [Transpiler](https://bun.com/docs/api/transpiler)
...
[Previous\\
\\
$ Shell](https://bun.com/docs/runtime/shell) [Next\\
\\
