...
[`Bun.version`](https://bun.com/docs/api/utils#bun-version) [`Bun.revision`](https://bun.com/docs/api/utils#bun-revision) [`Bun.env`](https://bun.com/docs/api/utils#bun-env) [`Bun.main`](https://bun.com/docs/api/utils#bun-main) [`Bun.sleep()`](https://bun.com/docs/api/utils#bun-sleep) [`Bun.sleepSync()`](https://bun.com/docs/api/utils#bun-sleepsync) [`Bun.which()`](https://bun.com/docs/api/utils#bun-which) [`Bun.randomUUIDv7()`](https://bun.com/docs/api/utils#bun-randomuuidv7) [`Bun.peek()`](https://bun.com/docs/api/utils#bun-peek) [`Bun.openInEditor()`](https://bun.com/docs/api/utils#bun-openineditor) [`Bun.deepEquals()`](https://bun.com/docs/api/utils#bun-deepequals) [`Bun.escapeHTML()`](https://bun.com/docs/api/utils#bun-escapehtml) [`Bun.stringWidth()` ~6,756x faster `string-width` alternative](https://bun.com/docs/api/utils#bun-stringwidth-6-756x-faster-string-width-alternative) [`Bun.fileURLToPath()`](https://bun.com/docs/api/utils#bun-fileurltopath) [`Bun.pathToFileURL()`](https://bun.com/docs/api/utils#bun-pathtofileurl) [`Bun.gzipSync()`](https://bun.com/docs/api/utils#bun-gzipsync) [`Bun.gunzipSync()`](https://bun.com/docs/api/utils#bun-gunzipsync) [`Bun.deflateSync()`](https://bun.com/docs/api/utils#bun-deflatesync) [`Bun.inflateSync()`](https://bun.com/docs/api/utils#bun-inflatesync) [`Bun.inspect()`](https://bun.com/docs/api/utils#bun-inspect) [`Bun.inspect.custom`](https://bun.com/docs/api/utils#bun-inspect-custom) [`Bun.inspect.table(tabularData, properties, options)`](https://bun.com/docs/api/utils#bun-inspect-table-tabulardata-properties-options) [`Bun.nanoseconds()`](https://bun.com/docs/api/utils#bun-nanoseconds) [`Bun.readableStreamTo*()`](https://bun.com/docs/api/utils#bun-readablestreamto) [`Bun.resolveSync()`](https://bun.com/docs/api/utils#bun-resolvesync) [`serialize` & `deserialize` in `bun:jsc`](https://bun.com/docs/api/utils#serialize-deserialize-in-bun-jsc) [`Bun.stripANSI()` ~6-57x faster `strip-ansi` alternative](https://bun.com/docs/api/utils#bun-stripansi-6-57x-faster-strip-ansi-alternative) [`estimateShallowMemoryUsageOf` in `bun:jsc`](https://bun.com/docs/api/utils#estimateshallowmemoryusageof-in-bun-jsc)

[Node-API](https://bun.com/docs/api/node-api) [Glob](https://bun.com/docs/api/glob) [DNS](https://bun.com/docs/api/dns) [Semver](https://bun.com/docs/api/semver) [Color](https://bun.com/docs/api/color) [Transpiler](https://bun.com/docs/api/transpiler)
...
\
This API is designed to match the popular "string-width" package, so thatexisting code can be easily ported to Bun and vice versa.\
\
...
```\
\
## [`Bun.pathToFileURL()`](https://bun.com/docs/api/utils\#bun-pathtofileurl)\
\
...
```\
\
## [`Bun.gzipSync()`](https://bun.com/docs/api/utils\#bun-gzipsync)\
\
...
```\
\
## [`Bun.gunzipSync()`](https://bun.com/docs/api/utils\#bun-gunzipsync)\
\
...
```\
\
## [`Bun.deflateSync()`](https://bun.com/docs/api/utils\#bun-deflatesync)\
\
...
```\
\
The second argument supports the same set of configuration options as [`Bun.gzipSync`](https://bun.com/docs/api/utils#bun-gzipsync).\
\
## [`Bun.inflateSync()`](https://bun.com/docs/api/utils\#bun-inflatesync)\
\
...
```\
\
## [`Bun.inspect.custom`](https://bun.com/docs/api/utils\#bun-inspect-custom)\
\
...
```\
\
## [`Bun.inspect.table(tabularData, properties, options)`](https://bun.com/docs/api/utils\#bun-inspect-table-tabulardata-properties-options)\
\
...
```\
\
## [`Bun.readableStreamTo*()`](https://bun.com/docs/api/utils\#bun-readablestreamto)\
\
...
```\
\
## [`serialize` & `deserialize` in `bun:jsc`](https://bun.com/docs/api/utils\#serialize-deserialize-in-bun-jsc)\
\
...
\
## [`Bun.stripANSI()` ~6-57x faster `strip-ansi` alternative](https://bun.com/docs/api/utils\#bun-stripansi-6-57x-faster-strip-ansi-alternative)\
\
...
```\
\
## [`estimateShallowMemoryUsageOf` in `bun:jsc`](https://bun.com/docs/api/utils\#estimateshallowmemoryusageof-in-bun-jsc)\
\
...
[Previous\\
\\
Testing](https://bun.com/docs/cli/test) [Next\\
\\
Node-API](https://bun.com/docs/api/node-api)\
\
[![GitHub logo](<Base64-Image-Removed>)![GitHub logo](<Base64-Image-Removed>)\\
\\
Edit on GitHub](https://github.com/oven-sh/bun/edit/main/docs/api/utils.md)\
\
Powered by\
\
