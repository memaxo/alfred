...
[`Bun.build`](https://bun.com/docs/bundler) [HTML & static sites](https://bun.com/docs/bundler/html) [CSS](https://bun.com/docs/bundler/css)

[Transpiling](https://bun.com/docs/bundler/css#transpiling) [Browser Compatibility](https://bun.com/docs/bundler/css#browser-compatibility) [Syntax Lowering](https://bun.com/docs/bundler/css#syntax-lowering) [CSS Modules](https://bun.com/docs/bundler/css#css-modules) [Getting started](https://bun.com/docs/bundler/css#getting-started) [Composition](https://bun.com/docs/bundler/css#composition) [Composing from a separate CSS module file](https://bun.com/docs/bundler/css#composing-from-a-separate-css-module-file)

[Fullstack Dev Server](https://bun.com/docs/bundler/fullstack) [Hot reloading](https://bun.com/docs/bundler/hmr) [Loaders](https://bun.com/docs/bundler/loaders) [Plugins](https://bun.com/docs/bundler/plugins) [Macros](https://bun.com/docs/bundler/macros) [vs esbuild](https://bun.com/docs/bundler/vs-esbuild)
...
The `styles` object from importing the CSS module file will be an object with all class names as keys andtheir unique identifiers as values:
...
The CSS module spec says that composing classes from separate files with conflicting properties isundefined behavior, meaning that the output may differ and be unreliable.

[Previous\\
\\
HTML & static sites](https://bun.com/docs/bundler/html) [Next\\
\\
