...
[Arguments and flags](https://bun.com/docs/cli/bunx#arguments-and-flags) [Shebangs](https://bun.com/docs/cli/bunx#shebangs)
...
[Previous\\
\\
DOM testing](https://bun.com/docs/test/dom) [Next\\
\\
