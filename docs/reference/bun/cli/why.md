...
[Usage](https://bun.com/docs/cli/why#usage) [Arguments](https://bun.com/docs/cli/why#arguments) [Options](https://bun.com/docs/cli/why#options) [Examples](https://bun.com/docs/cli/why#examples) [Understanding the Output](https://bun.com/docs/cli/why#understanding-the-output)
...
[Previous\\
\\
`bun pm`](https://bun.com/docs/cli/pm) [Next\\
\\
