...
[`--json`](https://bun.com/docs/install/audit#json) [Exit code](https://bun.com/docs/install/audit#exit-code)

[.npmrc support](https://bun.com/docs/install/npmrc) [Security Scanner API](https://bun.com/docs/install/security-scanner-api)
...
[Previous\\
\\
Patch dependencies](https://bun.com/docs/install/patch) [Next\\
\\
