...
[`"overrides"`](https://bun.com/docs/install/overrides#overrides) [`"resolutions"`](https://bun.com/docs/install/overrides#resolutions)

[Patch dependencies](https://bun.com/docs/install/patch) [Audit dependencies](https://bun.com/docs/install/audit) [.npmrc support](https://bun.com/docs/install/npmrc) [Security Scanner API](https://bun.com/docs/install/security-scanner-api)
...
[Previous\\
\\
Scopes and registries](https://bun.com/docs/install/registries) [Next\\
\\
