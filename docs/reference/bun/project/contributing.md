...
[Roadmap](https://bun.com/docs/project/roadmap) [Benchmarking](https://bun.com/docs/project/benchmarking) [Contributing](https://bun.com/docs/project/contributing)

[Install Dependencies](https://bun.com/docs/project/contributing#install-dependencies) [Install LLVM](https://bun.com/docs/project/contributing#install-llvm) [Building Bun](https://bun.com/docs/project/contributing#building-bun) [VSCode](https://bun.com/docs/project/contributing#vscode) [Running debug builds](https://bun.com/docs/project/contributing#running-debug-builds) [Code generation scripts](https://bun.com/docs/project/contributing#code-generation-scripts) [Modifying ESM modules](https://bun.com/docs/project/contributing#modifying-esm-modules) [Release build](https://bun.com/docs/project/contributing#release-build) [Download release build from pull requests](https://bun.com/docs/project/contributing#download-release-build-from-pull-requests) [AddressSanitizer](https://bun.com/docs/project/contributing#addresssanitizer) [Building WebKit locally + Debug mode of JSC](https://bun.com/docs/project/contributing#building-webkit-locally-debug-mode-of-jsc) [Troubleshooting](https://bun.com/docs/project/contributing#troubleshooting) ['span' file not found on Ubuntu](https://bun.com/docs/project/contributing#span-file-not-found-on-ubuntu) [libarchive](https://bun.com/docs/project/contributing#libarchive) [macOS `library not found for -lSystem`](https://bun.com/docs/project/contributing#macos-library-not-found-for-lsystem) [Cannot find `libatomic.a`](https://bun.com/docs/project/contributing#cannot-find-libatomic-a) [ccache conflicts with building TinyCC on macOS](https://bun.com/docs/project/contributing#ccache-conflicts-with-building-tinycc-on-macos) [Using bun-debug](https://bun.com/docs/project/contributing#using-bun-debug)

[Building Windows](https://bun.com/docs/project/building-windows) [Bindgen](https://bun.com/docs/project/bindgen) [License](https://bun.com/docs/project/licensing)
...
- The first line in [`src/js/builtins.d.ts`](https://bun.com/src/js/builtins.d.ts)
- The `CompilationDatabase` line in [`.clangd` config](https://bun.com/.clangd) should be `CompilationDatabase: build/debug-local`
- In [`build.zig`](https://bun.com/build.zig), the `codegen_path` option should be `build/debug-local/codegen` (instead of `build/debug/codegen`)
- In [`.vscode/launch.json`](https://bun.com/.vscode/launch.json), many configurations use `./build/debug/`, change them as you see fit
...
[Previous\\
\\
Benchmarking](https://bun.com/docs/project/benchmarking) [Next\\
\\
