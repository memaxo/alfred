...
[Default Discovery Logic](https://bun.com/docs/test/discovery#default-discovery-logic) [Exclusions](https://bun.com/docs/test/discovery#exclusions) [Customizing Test Discovery](https://bun.com/docs/test/discovery#customizing-test-discovery) [Position Arguments as Filters](https://bun.com/docs/test/discovery#position-arguments-as-filters) [Specifying Exact File Paths](https://bun.com/docs/test/discovery#specifying-exact-file-paths) [Filter by Test Name](https://bun.com/docs/test/discovery#filter-by-test-name) [Changing the Root Directory](https://bun.com/docs/test/discovery#changing-the-root-directory) [Execution Order](https://bun.com/docs/test/discovery#execution-order)
...
[Previous\\
\\
Runtime behavior](https://bun.com/docs/test/runtime-behavior) [Next\\
\\
DOM testing](https://bun.com/docs/test/dom)
