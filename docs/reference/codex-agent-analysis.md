...
The system implements a Retrieval-Augmented Generation (RAG) loop for _process knowledge_ (`packages/db/src/repo/codex-learning.ts`).
...
2.  **Cognitive Continuity**: The "Learning" repo turns the database into a long-term memory of _how to code_.
