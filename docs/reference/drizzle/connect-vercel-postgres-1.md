...
driver with `drizzle-orm/vercel-postgres` package and **[`postgres`](https://orm.drizzle.team/docs/connect-vercel-postgres#postgresjs)** or **[`pg`](https://orm.drizzle.team/docs/connect-vercel-postgres#node-postgres)**
...
either **[`postgres`](https://orm.drizzle.team/docs/connect-vercel-postgres#postgresjs)** or **[`pg`](https://orm.drizzle.team/docs/connect-vercel-postgres#node-postgres)**.
