...
Key Differences Feature| Request Middleware| Server Function Middleware
---|---|---
...
Core Concepts Middleware Composition
...
Context Management Providing Context via next
...
Request and Response Modification Reading/Modifying the Server Response
...
Environment and Performance Environment Tree Shaking
