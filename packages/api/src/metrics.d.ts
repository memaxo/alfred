...
export declare const trpcRequestsTotal: client.Counter<"procedure" | "type">;
export declare const trpcRequestErrorsTotal: client.Counter<"procedure" | "type" | "code">;
export declare const trpcRequestDurationSeconds: client.Histogram<"procedure" | "type">;
...
export declare const linearSessionOperationsTotal: client.Counter<"status" | "operation">;
