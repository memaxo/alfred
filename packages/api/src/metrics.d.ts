...
export declare const trpcRequestErrorsTotal: client.Counter<"type" | "procedure" | "code">;
export declare const trpcRequestDurationSeconds: client.Histogram<"type" | "procedure">;
export declare const healthChecksTotal: client.Counter<"target" | "status">;
...
export declare const evalFailuresTotal: client.Counter<"scorer" | "reason">;
...
export declare const memoryUpdatesTotal: client.Counter<"kind" | "source">;
...
export declare const linearActivityEmissionsTotal: client.Counter<"type" | "status">;
