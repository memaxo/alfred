...
export declare const dbFixtures: {
     ...
     */
    createRagDocument(db: NodePgDatabase, source?: string, content?: string): Promise<string>;
    /**
     * Creates a test assistant thread
     */
    createThread(db: NodePgDatabase, userId?: string, agent?: string): Promise<string>;
};
export {};
