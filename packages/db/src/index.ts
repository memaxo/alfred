...
export * as senseRepo from "./repo/sense";
export * as templateRepo from "./repo/template";
...
export * as senseSchema from "./schema/sense";
export * as templateSchema from "./schema/template";
