...
export type SonarrSystemStatus = z.infer<typeof systemStatusSchema>;

export class Sonarr {
  private readonly cfg: Required<SonarrCfg>;

  constructor(cfg: SonarrCfg) {
    this.cfg = {
  ...
  async systemStatus(): Promise<SonarrSystemStatus> {
