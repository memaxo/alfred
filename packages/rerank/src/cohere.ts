 ...
 * Text-only reranking via Cohere API
 *
 * Note: Will migrate to AI SDK v6 rerank() when @ai-sdk/cohere adds rerankingModel() support.
 */

import type { CohereRerankOptions, RerankResult } from "./types.js";

export type { CohereRerankOptions } from "./types.js";
...
export async function cohereRerank({
  ...
  model = "rerank-v3.5",
  telemetry,
}: CohereRerankOptions): Promise<RerankResult[]> {
